...
namespace Matrip.Web.Libraries.Text
{
    ...
    {
        public static string InFull(decimal valor)
        {
            ...
            else
            {
                ...
                {
                    valor_por_extenso += WriteInFull(Convert.ToDecimal(strValor.Substring(i, 3)));
        ...
        static string WriteInFull(decimal valor)
        {
            if (valor <= 0)
                return string.Empty;
            else
